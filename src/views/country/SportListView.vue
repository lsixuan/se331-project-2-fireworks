...
<template>
  <div
    class=" m-6 md:m-12 md:mt-8 md:mx-48 p-5 border border-gray-300 rounded-lg shadow-lg bg-[#2036c5e5] "
  >
    <div class="box-border py-2">
      <div
      class="grid items-center justify-items-center h-auto text-xl pb-4 gap-x-2.5 border-b-2 border-[#e1e335] md:mx-16 grid-cols-[minmax(0,4.5fr)_repeat(4,_1.5fr)]"
      >
